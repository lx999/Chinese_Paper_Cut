...
//					m_penMat.SetFloat("_Cutoff",1f);
	...
	public void ChangeCanvasColorToBlue(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.blue,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToBlack(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.black,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToCyan(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.cyan,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToGreen(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.green,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToGrey(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.grey,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToMagenta(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.magenta,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToRed(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.red,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorToWhite(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.white,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}

	public void ChangeCanvasColorYellow(){
		m_canvasMat = CreateMat(m_scribbleShader,Color.yellow,BlendMode.SrcAlpha,BlendMode.OneMinusSrcAlpha,1,0.02f);
		CreateQuad(m_canvasMat);
		m_canvasMat.SetTexture("_SourceTex",m_sourceTex);
		m_canvasMat.SetTexture("_RenderTex",m_rt);
	}
    ...
    public float GetRessouceHeight
    {
        get
        {
            return m_sourceTex.height;
        }

    }

    public float GetRessouceWidth
    {
        get
        {
            return m_sourceTex.width;
        }
